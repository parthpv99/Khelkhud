...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  // Future<DateTime> _SelecteDate(BuildContext context) => showDatePicker(
  //       context: context,
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: DropdownButton<String>(
                                  isExpanded: true,
                                  underline: SizedBox(),
                                  style: _selectedState == "Choose a state"
                                      ? TextStyle(color: Color(0xFFFE8B0E))
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: DropdownButton<String>(
                                  isExpanded: true,
                                  underline: SizedBox(),
                                  style: _selectedLGA == "Choose a city"
                                      ? TextStyle(color: Color(0xFFFE8B0E))
                                      : TextStyle(color: Colors.white),
                                  items: districts
